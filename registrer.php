...
<body>
    <div class="main">
        ...
        <?php if(isset($gender_error)){
            ...
            ?>
        <h7>Gender</h7>
        <select name="gender" titel='gender chose male or female'>
        ...
        <br>
        <input type="submit" name="submit" id="submit" value="Sing in"><br>
        </form>
        <h3>Or</h3><br>
